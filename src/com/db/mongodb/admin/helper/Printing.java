...
public class Printing {
    ...
    public static void main(String[] args) {    
        try {
            printComponentToFile(new AdminMainFrame(), true);
            printComponentToFile(new AdminMainFrame(), false);
    ...
    public static class ComponentPrinter implements Printable {
        ...
        public int print(Graphics g, PageFormat format, int page_index) throws PrinterException {
            ...
            double width = (double) Math.floor(format.getImageableWidth());
            double height = (double) Math.floor(format.getImageableHeight());
